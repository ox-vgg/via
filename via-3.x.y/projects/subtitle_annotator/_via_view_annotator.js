...
const _VIA_VIEW_MODE = {'UNKNOWN':0,
                        ...
                        'VIDEO1':101, 'VIDEO2':102, 'VIDEOK':103, 'VIDEO1_SUBTITLE':104,
  ...
  case 1:
    if ( this._view_has_only_image(vid) ) {
      ...
      if ( this._view_has_only_video(vid) ) {
        this._view_annotate_single_video_subtitle(vid);
        // @todo: automatically select the annotation mode: (1) single video or (2) single video with subtitle annotator
...
_via_view_annotator.prototype._view_annotate_single_video_subtitle = function(vid) {
  ...
  if(this.group_aid_candidate_list.length) {
    ...
    this.view_mode = _VIA_VIEW_MODE.VIDEO1_SUBTITLE;
  } else {
